    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(choices=[('INT', 'Стажер'), ('JUN', 'Джуниор'), ('MID', 'Миддл'), ('SNR', 'Синьор'), ('LD', 'Лид')], max_length=4)),
                ('status', models.CharField(choices=[('not_looking_for_a_job', 'Не ищу работу'), ('considering_offers', 'Рассматриваю предложения'), ('looking_for_a_job', 'Ищу работу')], max_length=26)),
